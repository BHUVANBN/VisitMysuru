  ...
  return (
    <>
      ...
      <nav className={`fixed left-0 right-0 z-50 transition-all duration-500 ease-out ${
        scrolled ? 'top-0 py-4 px-6' : 'top-0 py-0 px-0'
      }`}>
        <div className={`transition-all duration-500 ease-out ${
          scrolled 
            ? 'max-w-7xl mx-auto bg-orange-50/80 backdrop-blur-xl border border-white/50 rounded-2xl shadow-2xl shadow-orange-200/20' 
            : 'w-full bg-orange-50/70 backdrop-blur-md shadow-sm border-b border-white/40'
        }`}>
          ...
          {isMenuOpen && (
            <div className={`lg:hidden transition-all duration-500 ease-out ${
              scrolled 
                ? 'bg-orange-50/90 backdrop-blur-xl border-t border-white/30 rounded-b-2xl' 
                : 'border-t border-white/30 bg-orange-50/80 backdrop-blur-md'
            }`}>
